...
CREATE TABLE `STAT_PROCESSING_LOG` (
  ...
  `JOURNAL_CODE` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  ...
  `STATUS` enum('success','error','partial') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'success',
  PRIMARY KEY (`ID`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Tracks processed statistics log files to prevent duplicates';