...
class Episciences_Review
{
    ...
    public function save(): bool
    {
        ...
        // publisher
        $settingsValues[self::SETTING_JOURNAL_PUBLISHER] = trim($this->getSetting(self::SETTING_JOURNAL_PUBLISHER));

        $settingsValues[self::SETTING_JOURNAL_PUBLISHER_LOC] = trim($this->getSetting(self::SETTING_JOURNAL_PUBLISHER_LOC));
