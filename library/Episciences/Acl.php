...
class Episciences_Acl extends Ccsd_Acl
{
    ...
    public const CONFIGURABLE_RESOURCES = [ // configurable resources : see Episciences_Review
        ...
        self::ROLE_EDITOR => [
            ...
            'administratepaper-altsendprooftoauthor' => self::CONFIGURABLE_RESOURCE,
            'administratepaper-altreturntolayoutediting' => self::CONFIGURABLE_RESOURCE,
            'administratepaper-altapproveforpublication' => self::CONFIGURABLE_RESOURCE,
