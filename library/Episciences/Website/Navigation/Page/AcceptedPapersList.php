...
/**
 * Page Episciences_Website_Navigation_Page_AcceptedPapersList
 *
 */
class Episciences_Website_Navigation_Page_AcceptedPapersList extends Episciences_Website_Navigation_Page
{
    protected $_controller = 'browse';
    protected $_action = 'accepted-docs';
