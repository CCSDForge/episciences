        ...
        if ($editors) {
            ...
            foreach ($editors as $uid => $editor) {
                ...
                if (!$isAvailable) {
                    ...
                    $unavailableLabel = ' <span class="unavailable-badge" style="background-color: #ff8c00; color: white; padding: 2px 6px; border-radius: 3px; font-size: 11px; font-weight: bold; margin-left: 5px;">' . $unavailableText . '</span>';
