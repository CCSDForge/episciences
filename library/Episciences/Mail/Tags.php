...
class Episciences_Mail_Tags
{
    ...
    public const TAG_DESCRIPTION = [
        ...
        self::TAG_ALL_REVIEW_RESOURCES_LINK => 'lien vers les ressources de la revue (EX : https://dmtcs.episciences.org/website/public)',
        self::TAG_ANSWER => 'texte de la réponse à une demande de modifications',
        self::TAG_ARTICLE_ID => 'identifiant de l’article',
        self::TAG_ARTICLE_LINK => "link to article's management page",
        ...
        self::TAG_AUTHORS_NAMES => "les auteurs de l'article (Ex : Rodney, Hartman ;  Bryan, Daniel et John, Walls)",
        ...
        self::TAG_REVIEW_CE_RESOURCES_NAME => "nom du dossier zippé de l'ensemble de fichiers de style et les règles de préparation d'un document (EX : dmtcs_episciences.zip)",
        ...
        self::TAG_VOLUME_EDITORS => "tous les rédacteurs assignés au volume de l'article (Ex : Hartman Rodney, Daniel Bryan, Walls John)",
