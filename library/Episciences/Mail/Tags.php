...
class Episciences_Mail_Tags
{
    ...
    public const TAG_DESCRIPTION = [
        ...
        self::TAG_ALL_REVIEW_RESOURCES_LINK => 'le chemin vers les ressources de la revue (EX : https://dmtcs.episciences.org/website/public)',
        self::TAG_ANSWER => 'la réponse à une demande de modifications',
        self::TAG_ARTICLE_ID => 'identifiant de l’article',
        self::TAG_ARTICLE_LINK => "lien vers la page d'administration de l’article",
        ...
        self::TAG_AUTHORS_NAMES => "les auteurs d’un article",
        self::TAG_COMMENT => 'commentaire du relecteur',
        self::TAG_COMMENT_DATE => 'date de soumission de commentaire',
        self::TAG_CONTRIBUTOR_FULL_NAME => 'nom complet du déposant',
        self::TAG_CURRENT_YEAR => "l'année en cours (Ex : 2022)",
        self::TAG_DOI => "DOI de l'article : DOI_prefix/DOI_format (Ex : 10.46298/jdmdh.9251)",
        self::TAG_EDITOR_SCREEN_NAME => "nom d’affichage du rédacteur à l'origine de l'action (jouter un commentaire)",
        ...
        self::TAG_PAPER_REPO_URL => "lien vers la page de l'article sur l'archive ouverte (Ex : https://hal.archives-ouvertes.fr/hal-03242823v2)",
        ...
        self::TAG_RECIPIENT_USERNAME_LOST_LOGIN  => "Lien servant à la récupération du login (Ex : https://jtcam.episciences.org/user/lostlogin)",
        self::TAG_RECIPIENT_FULL_NAME => "nom complet du destinataire (Ex : Gaëlle Rivérieux)",
        self::TAG_RECIPIENT_SCREEN_NAME => "nom d’affichage du destinataire (Ex: Gaëlle R.)",
        self::TAG_RECIPIENT_USERNAME => "identifiant du destinataire (Ex : gaelle_riverieux)",
        ...
        self::TAG_REQUEST_DATE => "date de l'action",
        ...
        self::TAG_REVIEW_CE_RESOURCES_NAME => "nom de dossier zippé de l'ensemble de fichiers de style et les règles de préparation d'un document (EX : dmtcs_episciences.zip)",
        ...
        self::TAG_SECTION_NAME => 'nom de la section',
        ...
        self::TAG_VOLUME_EDITORS => "tous les rédacteurs assignés au volume de l'article (chaine de caractères)",
