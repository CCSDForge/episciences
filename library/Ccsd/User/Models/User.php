...

{
    ...
    {
        return Ccsd_File::slicedPathFromString(Episciences_Tools::getCleanedUuid($this->getUuid()), EPISCIENCES_USER_PHOTO_PATH . DIRECTORY_SEPARATOR . 'uuid' . DIRECTORY_SEPARATOR);
    }
