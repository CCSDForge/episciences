...
class Ccsd_Externdoc_Irstea_Paper extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_Paper
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_Paper($id);
...
Ccsd_Externdoc_Irstea::registerType("/produit/record[@xsi:type='ns2:paper']", "Ccsd_Externdoc_Irstea_Paper");