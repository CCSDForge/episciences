...
class Ccsd_Externdoc_Irstea_Thesis extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_Thesis
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_Thesis($id);
...
Ccsd_Externdoc_Irstea::registerType("Thèse", "Ccsd_Externdoc_Irstea_Thesis");