...
class Ccsd_Externdoc_Irstea_Report extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_Report
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_Report($id);
...
Ccsd_Externdoc_Irstea::registerType('Rapport', 'Ccsd_Externdoc_Irstea_Report');
Ccsd_Externdoc_Irstea::registerType("Rapport d'expertise/d'étude",'Ccsd_Externdoc_Irstea_Report');
Ccsd_Externdoc_Irstea::registerType('Rapport scientifique','Ccsd_Externdoc_Irstea_Report');
Ccsd_Externdoc_Irstea::registerType('Rapport technique','Ccsd_Externdoc_Irstea_Report');