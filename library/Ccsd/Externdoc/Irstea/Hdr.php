...
class Ccsd_Externdoc_Irstea_Hdr extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_Hdr
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_Hdr($id);
...
Ccsd_Externdoc_Irstea::registerType("HDR", "Ccsd_Externdoc_Irstea_Hdr");