...
class Ccsd_Externdoc_Irstea_BookTranslation extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_BookTranslation
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_BookTranslation($id);
...
Ccsd_Externdoc_Irstea::registerType("/produit/record[@xsi:type='ns2:bookTranslation']", "Ccsd_Externdoc_Irstea_BookTranslation");