...
class Ccsd_Externdoc_Irstea_ResearchReportChapter extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_ResearchReportChapter
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_ResearchreportChapter($id);
...
Ccsd_Externdoc_Irstea::registerType("/produit/record[@xsi:type='ns2:researchReportChapter']", "Ccsd_Externdoc_Irstea_ResearchReportChapter");