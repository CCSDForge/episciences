...
class Ccsd_Externdoc_Irstea_ResearchReport extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_ResearchReport
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_ResearchReport($id);
...
Ccsd_Externdoc_Irstea::registerType("/produit/record[@xsi:type='ns2:researchReport']", "Ccsd_Externdoc_Irstea_ResearchReport");