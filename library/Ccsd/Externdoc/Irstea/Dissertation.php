...
class Ccsd_Externdoc_Irstea_Dissertation extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_Dissertation
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_Dissertation($id);
...
Ccsd_Externdoc_Irstea::registerType("/produit/record[@xsi:type='ns2:dissertation']", "Ccsd_Externdoc_Irstea_Dissertation");