...
class Ccsd_Externdoc_Irstea_Map extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_Map
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_Map($id);
...
Ccsd_Externdoc_Irstea::registerType("/produit/record[@xsi:type='ns2:map']", "Ccsd_Externdoc_Irstea_Map");