...
class Ccsd_Externdoc_Irstea_Book extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_Book
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_Book($id);
...
Ccsd_Externdoc_Irstea::registerType("Ouvrage", "Ccsd_Externdoc_Irstea_Book");
Ccsd_Externdoc_Irstea::registerType("Ouvrage de vulgarisation","Ccsd_Externdoc_Irstea_Book");
Ccsd_Externdoc_Irstea::registerType("Ouvrage scientifique","Ccsd_Externdoc_Irstea_Book");
Ccsd_Externdoc_Irstea::registerType("Ouvrage technique/Guide technique","Ccsd_Externdoc_Irstea_Book");