...
class Ccsd_Externdoc_Irstea_Patent extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_Patent
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_Patent($id);
...
Ccsd_Externdoc_Irstea::registerType("Brevet", "Ccsd_Externdoc_Irstea_Patent");