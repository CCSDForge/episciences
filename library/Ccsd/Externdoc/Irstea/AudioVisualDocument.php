...
class Ccsd_Externdoc_Irstea_AudioVisualDocument extends Ccsd_Externdoc_Irstea
{
     ...
     * @return Ccsd_Externdoc_Irstea_AudioVisualDocument
     */
    static public function createFromXML($id, $xmlDom)
    {
        $doc = new Ccsd_Externdoc_Irstea_AudioVisualDocument($id);
...
Ccsd_Externdoc_Irstea::registerType("/produit/record[@xsi:type='ns2:audioVisualDocument']", "Ccsd_Externdoc_Irstea_AudioVisualDocument");