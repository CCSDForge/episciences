...
class Ccsd_Externdoc_Inra_Book extends Ccsd_Externdoc_Inra
{
    ...
    const META_ARRAY_BOOKTYPE =
        [   'Cahiers de recherche'=>'CR',
            'Dictionnaire/Encyclopédie'=>'DE',
            'Synthèse'=>'SY',
            'Traduction'=>'TR'
        ];
    ...
    public function getBookType(){
        ...
        if (!empty($bookType) && isset(self::META_ARRAY_BOOKTYPE[$bookType])){
            $bookType=self::META_ARRAY_BOOKTYPE[$bookType];
        }
        else {
            $bookType = '0';
        }
