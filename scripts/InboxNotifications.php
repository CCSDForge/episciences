...
class InboxNotifications extends AbstractScript
{
    ...
    public function run(): void
    {
        ...
        if ($count >= NotificationsRepository::MAX_INBOUND_FETCH) {
            $this->logger->warning(sprintf(
                'Inbox fetch hit the %d-row limit — some notifications may have been skipped.',
                NotificationsRepository::MAX_INBOUND_FETCH
            ));
        }
     ...
     * @param Episciences_Comment|null $originalRequest
     * @param bool $isFirstSubmission
