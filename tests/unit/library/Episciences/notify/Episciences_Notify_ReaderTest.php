...
class Episciences_Notify_ReaderTest extends TestCase
{
    ...
    public function testGetNotificationsIgnoresDirectionParameter(): void
    {
        // The direction parameter is retained in the signature for BC but delegates
        // to findInbound() regardless of the value passed.
        $repository = $this->createMock(NotificationsRepository::class);
        $repository
            ->expects(self::once())
            ->method('findInbound')
