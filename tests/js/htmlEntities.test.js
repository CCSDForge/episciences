...
describe('htmlEntities', function() {
    ...
    it('should escape double quotes', function() {
        expect(htmlEntities('He said "Hello"')).toBe('He said &quot;Hello&quot;');
        expect(htmlEntities('"')).toBe('&quot;');
    ...
    it('should escape single quotes', function() {
        ...
        expect(htmlEntities("'")).toBe('&#39;');
        expect(htmlEntities("onclick='alert()'")).toBe('onclick=&#39;alert()&#39;');
    });

    it('should escape multiple different entities', function() {
        expect(htmlEntities('<div title="test">Tom & Jerry\'s</div>'))
            .toBe('&lt;div title=&quot;test&quot;&gt;Tom &amp; Jerry&#39;s&lt;/div&gt;');
    });
    ...
    it('should handle XSS prevention', function() {
        expect(htmlEntities('<script>alert("XSS")</script>'))
            .toBe('&lt;script&gt;alert(&quot;XSS&quot;)&lt;/script&gt;');
        expect(htmlEntities('<img src="x" onerror="alert(\'XSS\')">'))
            .toBe('&lt;img src=&quot;x&quot; onerror=&quot;alert(&#39;XSS&#39;)&quot;&gt;');
    });

    it('should handle mixed content', function() {
        expect(htmlEntities('Price: $5 < $10 & "discount" available'))
            .toBe('Price: $5 &lt; $10 &amp; &quot;discount&quot; available');
    });
});