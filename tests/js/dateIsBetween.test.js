...
describe('dateIsBetween function', function() {
    ...
    describe('Basic date range validation', function() {
        it('should return true for date within range', function() {
            expect(dateIsBetween('2023-06-15', '2023-06-01', '2023-06-30')).toBe(true);
            expect(dateIsBetween('2023-12-25', '2023-01-01', '2023-12-31')).toBe(true);
        });
        
        it('should return false for date outside range', function() {
            expect(dateIsBetween('2023-05-31', '2023-06-01', '2023-06-30')).toBe(false);
            expect(dateIsBetween('2023-07-01', '2023-06-01', '2023-06-30')).toBe(false);
        });
        
        it('should return true for date exactly at boundaries (inclusive)', function() {
            expect(dateIsBetween('2023-06-01', '2023-06-01', '2023-06-30')).toBe(true);
            expect(dateIsBetween('2023-06-30', '2023-06-01', '2023-06-30')).toBe(true);
        });
        
        it('should handle same min and max date', function() {
            expect(dateIsBetween('2023-06-15', '2023-06-15', '2023-06-15')).toBe(true);
            expect(dateIsBetween('2023-06-14', '2023-06-15', '2023-06-15')).toBe(false);
            expect(dateIsBetween('2023-06-16', '2023-06-15', '2023-06-15')).toBe(false);
        });
    });
    ...
    describe('Missing boundary parameters', function() {
        it('should return true when min is missing', function() {
            ...
            expect(dateIsBetween('2023-06-15', undefined, '2023-06-30')).toBe(true);
        ...
        it('should return true when max is missing', function() {
            ...
            expect(dateIsBetween('2023-06-15', '2023-06-01', undefined)).toBe(true);
        ...
        it('should return true when both boundaries are missing', function() {
            ...
            expect(dateIsBetween('2023-06-15', undefined, undefined)).toBe(true);
    ...
    describe('Invalid date handling', function() {
        it('should return false for invalid input date', function() {
            expect(dateIsBetween('invalid-date', '2023-06-01', '2023-06-30')).toBe(false);
            expect(dateIsBetween('2023-13-45', '2023-06-01', '2023-06-30')).toBe(false);
            expect(dateIsBetween('not-a-date', '2023-06-01', '2023-06-30')).toBe(false);
        });
        
        it('should return false for invalid min date', function() {
            expect(dateIsBetween('2023-06-15', 'invalid-date', '2023-06-30')).toBe(false);
            expect(dateIsBetween('2023-06-15', '2023-13-45', '2023-06-30')).toBe(false);
        });
        
        it('should return false for invalid max date', function() {
            expect(dateIsBetween('2023-06-15', '2023-06-01', 'invalid-date')).toBe(false);
            expect(dateIsBetween('2023-06-15', '2023-06-01', '2023-13-45')).toBe(false);
        });
        
        it('should return false when any date is invalid', function() {
            expect(dateIsBetween('invalid', 'invalid', 'invalid')).toBe(false);
            expect(dateIsBetween('2023-06-15', 'invalid', 'invalid')).toBe(false);
            expect(dateIsBetween('invalid', '2023-06-01', 'invalid')).toBe(false);
        });
    });
    
    describe('Date range validation', function() {
        it('should return false when min > max', function() {
            expect(dateIsBetween('2023-06-15', '2023-06-30', '2023-06-01')).toBe(false);
            expect(dateIsBetween('2023-06-15', '2023-12-31', '2023-01-01')).toBe(false);
        });
    ...
    describe('Different date formats', function() {
        ...
        it('should handle US date format (MM/DD/YYYY)', function() {
            expect(dateIsBetween('06/15/2023', '06/01/2023', '06/30/2023')).toBe(true);
            expect(dateIsBetween('05/31/2023', '06/01/2023', '06/30/2023')).toBe(false);
        });
        
        it('should handle full date strings', function() {
            expect(dateIsBetween('June 15, 2023', 'June 1, 2023', 'June 30, 2023')).toBe(true);
            expect(dateIsBetween('May 31, 2023', 'June 1, 2023', 'June 30, 2023')).toBe(false);
        });
        
        it('should handle mixed date formats', function() {
            expect(dateIsBetween('2023-06-15', 'June 1, 2023', '06/30/2023')).toBe(true);
            expect(dateIsBetween('June 15, 2023', '2023-06-01', '06/30/2023')).toBe(true);
        });
    });
    ...
    describe('Date object inputs', function() {
        ...
        it('should handle mixed Date objects and strings', function() {
            const inputDate = new Date('2023-06-15');
            expect(dateIsBetween(inputDate, '2023-06-01', '2023-06-30')).toBe(true);
            expect(dateIsBetween('2023-06-15', new Date('2023-06-01'), '2023-06-30')).toBe(true);
            expect(dateIsBetween('2023-06-15', '2023-06-01', new Date('2023-06-30'))).toBe(true);
        });
    });
    
    describe('Time component handling', function() {
        it('should handle dates with time components', function() {
            expect(dateIsBetween('2023-06-15T10:30:00', '2023-06-01', '2023-06-30')).toBe(true);
            expect(dateIsBetween('2023-06-15', '2023-06-01T00:00:00', '2023-06-30T23:59:59')).toBe(true);
        });
        
        it('should handle same date with different times', function() {
            expect(dateIsBetween('2023-06-15T10:30:00', '2023-06-15T09:00:00', '2023-06-15T11:00:00')).toBe(true);
            expect(dateIsBetween('2023-06-15T08:30:00', '2023-06-15T09:00:00', '2023-06-15T11:00:00')).toBe(false);
            expect(dateIsBetween('2023-06-15T12:30:00', '2023-06-15T09:00:00', '2023-06-15T11:00:00')).toBe(false);
        });
    });
    ...
    describe('Edge cases and special values', function() {
        ...
        it('should handle undefined values', function() {
            expect(dateIsBetween(undefined, '2023-06-01', '2023-06-30')).toBe(false);
            expect(dateIsBetween('2023-06-15', undefined, undefined)).toBe(true); // Missing boundaries
        });
    });
    
    describe('Year boundaries and long ranges', function() {
        it('should handle year boundaries', function() {
            expect(dateIsBetween('2023-01-01', '2022-12-31', '2023-01-02')).toBe(true);
            expect(dateIsBetween('2022-12-31', '2022-12-30', '2023-01-01')).toBe(true);
        });
        
        it('should handle multi-year ranges', function() {
            expect(dateIsBetween('2022-06-15', '2020-01-01', '2025-12-31')).toBe(true);
            expect(dateIsBetween('2019-12-31', '2020-01-01', '2025-12-31')).toBe(false);
            expect(dateIsBetween('2026-01-01', '2020-01-01', '2025-12-31')).toBe(false);
        });
        
        it('should handle leap year dates', function() {
            expect(dateIsBetween('2024-02-29', '2024-02-01', '2024-03-01')).toBe(true);
            ...
            expect(dateIsBetween('2023-02-29', '2023-02-01', '2023-03-01')).toBe(true); // Becomes March 1, 2023
        });
    });
    ...
    describe('Performance and practical use cases', function() {
        it('should handle typical date validation scenarios', function() {
            ...
            expect(dateIsBetween('2023-07-15', '2023-07-01', '2023-07-31')).toBe(true);
            ...
            expect(dateIsBetween('1990-06-15', hundredYearsAgo.toISOString().split('T')[0], eighteenYearsAgo.toISOString().split('T')[0])).toBe(true);
        });
        
        it('should handle business date ranges', function() {
            // Quarter validation
            expect(dateIsBetween('2023-05-15', '2023-04-01', '2023-06-30')).toBe(true); // Q2
            expect(dateIsBetween('2023-03-31', '2023-04-01', '2023-06-30')).toBe(false); // Before Q2
            expect(dateIsBetween('2023-07-01', '2023-04-01', '2023-06-30')).toBe(false); // After Q2
        });
    ...
    describe('Comparison with original implementation issues', function() {
        ...
        it('should properly validate dates instead of accepting Invalid Date objects', function() {
            ...
            expect(dateIsBetween('invalid-date', '2023-06-01', '2023-06-30')).toBe(false);
            expect(dateIsBetween('2023-06-15', 'invalid-min', '2023-06-30')).toBe(false);
            expect(dateIsBetween('2023-06-15', '2023-06-01', 'invalid-max')).toBe(false);
        });
