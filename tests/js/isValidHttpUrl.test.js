...
describe('isValidHttpUrl', function() {
    ...
    describe('Protocol validation', function() {
        ...
        it('should reject other protocols', function() {
            ...
            expect(isValidHttpUrl('data:text/plain;base64,SGVsbG8=')).toBe(false);
        });
    ...
    describe('Hostname validation', function() {
        it('should accept valid domain names', function() {
            ...
            expect(isValidHttpUrl('https://test-site.example-domain.co.uk')).toBe(true);
        });
    ...
    describe('Complete URL validation', function() {
        it('should accept URLs with paths', function() {
            ...
            expect(isValidHttpUrl('https://example.com/path/file.html')).toBe(true);
        });

        it('should accept URLs with query parameters', function() {
            expect(isValidHttpUrl('https://example.com?param=value')).toBe(true);
            expect(isValidHttpUrl('https://example.com/search?q=test&type=web')).toBe(true);
        });
    ...
    describe('Real-world URLs', function() {
        ...
        it('should accept API endpoints', function() {
            expect(isValidHttpUrl('https://api.example.com/v1/users')).toBe(true);
            expect(isValidHttpUrl('https://jsonplaceholder.typicode.com/posts/1')).toBe(true);
        });
        ...
        it('should accept development URLs', function() {
            ...
            expect(isValidHttpUrl('http://192.168.1.100:8080/admin')).toBe(true);
        });
    ...
    describe('Edge cases and security', function() {
        ...
        it('should handle URLs with special characters correctly', function() {
            expect(isValidHttpUrl('https://example.com/path with spaces')).toBe(true); // URL constructor handles encoding
            expect(isValidHttpUrl('https://example.com/path?query=value%20with%20spaces')).toBe(true);
        });
    });
