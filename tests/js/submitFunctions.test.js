...
describe('Submit Functions', () => {
  ...
  describe('removeVersionFromIdentifier', () => {
    test('should extract version from identifier ending with v+number', () => {
      ...
      const result = removeVersionFromIdentifier('hal-05191818v1', { mockVersionField });
    ...
    test('should extract version from arxiv identifier with version', () => {
      const mockVersionField = createMockElement('');
      const result = removeVersionFromIdentifier('2310.02192v1', { mockVersionField });
    ...
    test('should handle multi-digit versions', () => {
      const mockVersionField = createMockElement('');
      const result = removeVersionFromIdentifier('hal-05191818v21', { mockVersionField });
    ...
    test('should return original identifier when no version found', () => {
      ...
      const result = removeVersionFromIdentifier('hal-05191818', { mockVersionField });
    ...
    test('should not match version in middle of identifier', () => {
      const mockVersionField = createMockElement('');
      const result = removeVersionFromIdentifier('hal-v1-05191818', { mockVersionField });
  ...
  describe('processUrlIdentifier', () => {
    ...
    describe('ArXiv URLs', () => {
      test('should process arxiv URL with version', () => {
        const mockVersionField = createMockElement('');
        const result = processUrlIdentifier('https://arxiv.org/abs/2310.02192v1', { mockVersionField });
        
        // ArXiv URLs get special handling: extract only the ArXiv ID from /abs/ path
        // then removeVersionFromIdentifier strips 'v1' to get "2310.02192"
        expect(result).toBe('2310.02192');
        expect(mockVersionField.value).toBe('1');
      });
      ...
      test('should process arxiv URL without version', () => {
        const mockVersionField = createMockElement('');
        const result = processUrlIdentifier('https://arxiv.org/abs/2310.02192', { mockVersionField });
        
        // ArXiv URLs get special handling to extract only the ArXiv ID
        expect(result).toBe('2310.02192');
        expect(mockVersionField.value).toBe('');
      });

      test('should process old arxiv URL with category (hep-th) and version', () => {
        const mockVersionField = createMockElement('');
      ...
      test('should process old arxiv URL with category (hep-th) without version', () => {
        const mockVersionField = createMockElement('');
      ...
      test('should process old arxiv URL with category (alg-geom) and version', () => {
        const mockVersionField = createMockElement('');
      ...
      test('should process old arxiv URL with category (alg-geom) without version', () => {
        const mockVersionField = createMockElement('');
    ...
    describe('HAL URLs', () => {
      test('should process hal URL with version', () => {
        const mockVersionField = createMockElement('');
        const result = processUrlIdentifier('https://hal.science/hal-05191818v1', { mockVersionField });
      ...
      test('should process hal URL without version', () => {
        const mockVersionField = createMockElement('');
        const result = processUrlIdentifier('https://hal.science/hal-05191818', { mockVersionField });
    ...
    describe('Dataverse URLs', () => {
      test('should process Darus dataverse URL with persistentId and version', () => {
        const mockVersionField = createMockElement('');
        const url = 'https://darus.uni-stuttgart.de/dataset.xhtml?persistentId=doi:10.18419/DARUS-2277&version=2.0';
      ...
      test('should process French research data URL with persistentId and version', () => {
        const mockVersionField = createMockElement('');
        const url = 'https://entrepot.recherche.data.gouv.fr/dataset.xhtml?persistentId=doi:10.15454/XRXSHL&version=1.1';
        const result = processUrlIdentifier(url, { 
          mockVersionField, 
          isDataverseRepo: true 
        });
      ...
      test('should process dataverse URL with only persistentId', () => {
        const mockVersionField = createMockElement('');
        const url = 'https://darus.uni-stuttgart.de/dataset.xhtml?persistentId=doi:10.18419/DARUS-2277';
        const result = processUrlIdentifier(url, { 
          mockVersionField, 
          isDataverseRepo: true 
        });
      ...
      test('should handle dataverse URL without persistentId', () => {
        const mockVersionField = createMockElement('');
        const url = 'https://darus.uni-stuttgart.de/dataset.xhtml?someOtherParam=value';
        const result = processUrlIdentifier(url, { 
          mockVersionField, 
          isDataverseRepo: true 
        });
    ...
    describe('Error handling', () => {
      test('should handle invalid URLs gracefully', () => {
        ...
        const mockVersionField = createMockElement('');
        const result = processUrlIdentifier('not-a-valid-url', { mockVersionField });
      ...
      test('should handle malformed URLs', () => {
        const mockVersionField = createMockElement('');
        const result = processUrlIdentifier('https://.com/path', { mockVersionField });
    ...
    describe('Direct identifiers (non-URLs)', () => {
      test('should process direct identifier with version', () => {
        ...
        const mockVersionField = createMockElement('');
        const result = processUrlIdentifier('2310.02192v1', { mockVersionField });
      ...
      test('should process direct identifier without version', () => {
        ...
        const mockVersionField = createMockElement('');
        const result = processUrlIdentifier('2310.02192', { mockVersionField });
  ...
  describe('setPlaceholder', () => {
    ...
    test('should set placeholder text based on repository selection', () => {
      ...
      expect(mockDocIdField.attributes.placeholder).toBe('[exemple : ]2310.02192');
      expect(mockDocIdField.attributes.size).toBe('[exemple : ]2310.02192'.length);
    });
    ...
    test('should handle HAL repository selection', () => {
      ...
      expect(mockDocIdField.attributes.placeholder).toBe('[exemple : ]hal-05191818');
    });
