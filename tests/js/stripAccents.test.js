...
describe('stripAccents function', function() {
    ...
    describe('Mixed languages and complex cases', function() {
        it('should handle text with multiple different accents', function() {
            expect(stripAccents('Café München Zürich')).toBe('Cafe Munchen Zurich');
    ...
    describe('Performance and browser compatibility', function() {
        ...
        it('should handle large strings efficiently', function() {
            ...
            const expectedString = 'cafe resume Munchen Jose naive '.repeat(100);
    ...
    describe('Real-world use cases', function() {
        it('should handle typical search scenarios', function() {
            ...
            expect(stripAccents('Rechercher "café français"')).toBe('Rechercher "cafe francais"');
            expect(stripAccents('München Hauptbahnhof')).toBe('Munchen Hauptbahnhof');
        });
        
        it('should handle user names and addresses', function() {
            expect(stripAccents('José María González')).toBe('Jose Maria Gonzalez');
        ...
        it('should handle academic titles and institutions', function() {
            expect(stripAccents('Université de Montréal')).toBe('Universite de Montreal');
            expect(stripAccents('École Polytechnique')).toBe('Ecole Polytechnique');
