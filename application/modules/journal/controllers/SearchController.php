...
class SearchController extends Zend_Controller_Action
{
    ...
    public function indexAction ()
    {
    	...
    	->setQuery($q)
    	->setStart($startParam)
    	->setRows($search->getParsedSearchParamsbyKey('rows'))
    	...
    	$search->setQuery($query);
    	$search->queryAddFacets(Episciences_Settings::getConfigFile('solr.es.facets.json'))->queryAddResultPerPage(Episciences_Settings_Search::$_numberSearchResultsArray, Episciences_Settings_Search::DEFAULT_NUMBER_SEARCH_RESULTS);
    	$query = $search->getQuery();
