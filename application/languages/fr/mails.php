...
return [
    ...
    "paper_comment_from_author_to_editor_coauthor_copy_tpl_name" => "Message d'un co-auteur aux rédacteurs assignés (copie destinée aux co-auteurs)",
    "paper_comment_from_author_to_editor_coauthor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - un co-auteur a envoyé un message aux rédacteurs concernant %%ARTICLE_RELATIONSHIP%%",

    // Message d'un éditeur à l'auteur
    "paper_comment_from_editor_to_author_author_copy_tpl_name" => "Message d'un rédacteur à l'auteur (copie destinée à l'auteur)",
    "paper_comment_from_editor_to_author_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Un rédacteur vous a envoyé un message",
    ...
    // Pipeline éditorial alternatif
    "paper_alt_request_final_version_author_copy_tpl_name" => "Pipeline alternatif : demande de version finale et mot de passe - copie auteur",
    "paper_alt_request_final_version_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Version finale et mot de passe arXiv demandés",
    "paper_alt_final_version_deposit_author_copy_tpl_name" => "Pipeline alternatif : version finale et mot de passe déposés - copie auteur",
    "paper_alt_final_version_deposit_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Votre version finale et votre mot de passe ont été reçus",
    "paper_alt_final_version_deposit_editor_copy_tpl_name" => "Pipeline alternatif : version finale et mot de passe déposés - copie rédacteur/préparateur de copie",
    "paper_alt_final_version_deposit_editor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Version finale et mot de passe déposés par l'auteur",
    "paper_alt_start_layout_editing_copyeditor_copy_tpl_name" => "Pipeline alternatif : démarrage de la mise en page - copie préparateur de copie",
    "paper_alt_start_layout_editing_copyeditor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - La mise en page peut commencer",
    "paper_alt_incorrect_password_author_copy_tpl_name" => "Pipeline alternatif : mot de passe arXiv incorrect - copie auteur",
    "paper_alt_incorrect_password_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Le mot de passe arXiv doit être corrigé",
    "paper_alt_incorrect_latex_author_copy_tpl_name" => "Pipeline alternatif : fichiers LaTeX incorrects - copie auteur",
    "paper_alt_incorrect_latex_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Les fichiers de la version finale doivent être corrigés",
    "paper_alt_send_proof_to_author_author_copy_tpl_name" => "Pipeline alternatif : épreuve envoyée à l'auteur",
    "paper_alt_send_proof_to_author_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Merci de vérifier l'épreuve de votre article",
    "paper_alt_return_to_layout_editing_copyeditor_copy_tpl_name" => "Pipeline alternatif : retour en mise en page - copie préparateur de copie",
    "paper_alt_return_to_layout_editing_copyeditor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - L'épreuve retourne en mise en page",
    "paper_alt_author_approved_proof_editor_copy_tpl_name" => "Pipeline alternatif : épreuve approuvée par l'auteur - copie rédacteur/préparateur de copie",
    "paper_alt_author_approved_proof_editor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Épreuve approuvée par l'auteur",
    "paper_alt_author_rejected_proof_editor_copy_tpl_name" => "Pipeline alternatif : épreuve refusée par l'auteur - copie rédacteur/préparateur de copie",
    "paper_alt_author_rejected_proof_editor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Corrections demandées par l'auteur sur l'épreuve",
    "paper_alt_approve_for_publication_author_copy_tpl_name" => "Pipeline alternatif : article approuvé pour publication - copie auteur",
    "paper_alt_approve_for_publication_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Votre article est prêt pour publication",
