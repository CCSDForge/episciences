...
return [
    ...
    "paper_alt_start_layout_editing_author_copy_tpl_name" => "Pipeline alternatif : démarrage de la mise en page - copie auteur",
    "paper_alt_start_layout_editing_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - La mise en page a commencé",
