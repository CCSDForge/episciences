...
return [
    ...
    'a répondu à votre message concernant' => 'a répondu à votre message concernant',
    'vous a envoyé un message concernant' => 'vous a envoyé un message concernant',
    'a répondu aux rédacteurs concernant' => 'a répondu aux rédacteurs concernant',
    'a envoyé un message aux rédacteurs concernant' => 'a envoyé un message aux rédacteurs concernant',
    ...
    "administratemailinglist-manage" => "Gérer les membres d'une liste de diffusion",
    "administratemailinglist-delete" => "Supprimer une liste de diffusion",
    "mailing_list_type_open" => "Ouverte — tout le monde peut écrire",
    "mailing_list_type_subscribers" => "Membres uniquement — seuls les membres peuvent écrire",
    "Controls who can send messages to this list." => "Définit qui peut envoyer des messages à cette liste.",
    "Enabled" => "Activée",
    "Disabled" => "Désactivée",
    "The type of the mandatory mailing list is fixed to: Open (anyone can send)." => "Le type de la liste de diffusion obligatoire est fixé à : Ouverte (tout le monde peut écrire).",
    "The list has been automatically disabled because it has no members." => "La liste a été automatiquement désactivée car elle ne comporte aucun membre.",
    "Leave empty to use the main journal list. A dash is added automatically: rvcode-yourname@domain" => "Laissez vide pour utiliser la liste principale de la revue. Un tiret est ajouté automatiquement : rvcode-sousnom@domain",
    ...
    "Open" => "Ouverte",
    "Closed" => "Fermée",
    "No mailing list found." => "Aucune liste de diffusion trouvée.",
    ...
    "Roles" => "Rôles",
    "Users with these roles will be automatically included." => "Les utilisateurs avec ces rôles seront automatiquement inclus.",
    "Individual Members" => "Membres individuels",
    "Add users" => "Ajouter des utilisateurs",
    "No individual members selected." => "Aucun membre individuel sélectionné.",
    "User" => "Utilisateur",
    ...
    "Search by name, screen name or role" => "Chercher par nom, pseudonyme ou rôle",
    "Type to filter..." => "Taper pour filtrer...",
    "Remove user" => "Retirer l'utilisateur",
    "added to list" => "ajouté à la liste",
    "removed from list" => "retiré de la liste",
    "Final Audience Preview" => "Aperçu de l'audience finale",
    "Update Preview" => "Mettre à jour l'aperçu",
    "Search in audience" => "Chercher dans l'audience",
    "Firstname" => "Prénom",
    "Lastname" => "Nom",
    "Email" => "E-mail",
    "Copy to clipboard" => "Copier dans le presse-papier",
    "Copied!" => "Copié !",
    "Copy list name to clipboard" => "Copier le nom de la liste dans le presse-papier",
    "No members match the current selection." => "Aucun membre ne correspond à la sélection actuelle.",
    "Get started by creating your first list" => "Commencez par créer votre première liste",
    "Edit Settings" => "Modifier les paramètres",
    "Manage Members" => "Gérer les membres",
    "The mandatory mailing list cannot be deleted." => "La liste de diffusion obligatoire ne peut pas être supprimée.",
    "The type of the mandatory mailing list is fixed to Open." => "Le type de la liste de diffusion obligatoire est fixé à Ouverte.",
    "The journal prefix and domain are added automatically." => "Le préfixe de la revue et le domaine sont ajoutés automatiquement.",
    "The journal prefix and domain are added automatically. Leave the name empty to manage the main journal list." => "Le préfixe de la revue et le domaine sont ajoutés automatiquement. Laissez le nom vide pour gérer la liste principale de la revue.",
    "(optional sub-name)" => "(sous-nom optionnel)",
    "Only alphanumeric characters, dots, dashes and underscores are allowed." => "Seuls les caractères alphanumériques, points, tirets et underscores sont autorisés.",
    "The journal code is automatically added as a prefix." => "Le code de la revue est automatiquement ajouté comme préfixe.",
    "Save Changes" => "Enregistrer les modifications",
    "users" => "utilisateurs",
    "Add Individual Members" => "Ajouter des membres individuels",
    "All active roles" => "Tous les rôles actifs",
    "Search by name or pseudonym" => "Chercher par nom ou pseudonyme",
    "Search by name, screen name or role..." => "Chercher par nom, pseudonyme ou rôle...",
    "Filter final audience by name or email..." => "Filtrer l'audience finale par nom ou e-mail...",
    "Member" => "Membre",
    "This list is dynamically resolved from active roles and individual members." => "Cette liste est résolue dynamiquement à partir des rôles actifs et des membres individuels.",
    "Changes take effect immediately for the view." => "Les modifications prennent effet immédiatement pour la vue.",
    "Audience preview updated" => "Aperçu de l'audience mis à jour",
    "Failed to update preview" => "Échec de la mise à jour de l'aperçu",
    "Refresh based on current selections" => "Actualiser basé sur les sélections actuelles",
    ...
    "Invalid list type." => "Type de liste invalide.",
    ...
    "isTranslationOf" => "Est une traduction de",
    "hasTranslation" => "A une traduction",
    "isPreprintOf" => "Est une pré-publication de",
    "hasPreprint" => "A une pré-publication",
    "isManuscriptOf" => "Est un manuscrit de",
    "hasManuscript" => "A un manuscrit",
    "isExpressionOf" => "Est une expression de",
    "hasExpression" => "A une expression",
    "isManifestationOf" => "Est une manifestation de",
    "hasManifestation" => "A une manifestation",
    "isReplacedBy" => "Est remplacé par",
    "replaces" => "Remplace",
    "isSameAs" => "Est identique à",
    "isIdenticalTo" => "Est identique à",
    "isVariantFormOf" => "Est une forme variante de",
    "isOriginalFormOf" => "Est la forme originale de",
    "isFormatOf" => "Est un format de",
    "hasFormat" => "A un format",
