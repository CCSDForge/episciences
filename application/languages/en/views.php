...
return array(
    ...
    "Active un workflow simplifié destiné aux revues qui s'appuient sur arXiv. Après acceptation, l'administrateur demande à l'auteur son mot de passe arXiv et sa version finale ; le préparateur de copie met l'article en page ; l'épreuve est envoyée à l'auteur pour validation ; après l'approbation de l'auteur, l'administrateur valide la mise en page puis publie l'article." => "Enables a simplified workflow for journals relying on arXiv. After acceptance, the administrator requests the author's arXiv password and final version; the copy editor lays out the paper; the proof is sent to the author for validation; once the author has approved it, the administrator validates the layout and publishes the paper.",
