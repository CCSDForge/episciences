...
return array(
    ...
    "mailing_list_type_open" => "Open",
    "mailing_list_type_subscribers" => "Subscribers only",
    ...
    "The type of the mandatory mailing list is fixed to Open." => "The type of the mandatory mailing list is fixed to Open.",
