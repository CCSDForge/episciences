...
return array(
    ...
    // Reviewer statistics (ReviewersstatsController / MyreviewstatsController)
    "Statistiques des relecteurs" => "Reviewer statistics",
    "Statistiques des relecteurs sur le dernier mois" => array("Reviewer statistics over the last month", "Reviewer statistics over the last %d months"),
    "Rechercher un relecteur" => "Search for a reviewer",
    "Nom, email..." => "Name, email...",
    "Période" => "Period",
    "%d derniers mois" => "Last %d months",
    "Périmètre" => "Scope",
    "Afficher uniquement les relecteurs ayant" => "Only show reviewers with",
    "Réinitialiser les filtres" => "Reset filters",
    "En retard" => "Overdue",
    "Uniquement les articles dont je suis responsable" => "Only papers I am responsible for",
    "Filtrer" => "Filter",
    "Retard max (jours)" => "Max delay (days)",
    "Relances envoyées" => "Reminders sent",
    "Dernière sollicitation" => "Last invitation",
    "Dernier rapport soumis" => "Last report submitted",
    ...
    "%d retard" => array("%d overdue", "%d overdue"),
    ...
    "En retard de %d jour" => array("%d day overdue", "%d days overdue"),
    "Non renseigné" => "Not specified",
    "Date d’envoi" => "Sent on",
    "Statut de la relecture" => "Review status",
    "Échéance" => "Deadline",
    "Date de complétion" => "Completed on",
    "Version %s" => "Version %s",
    "Remplacée par une tentative ultérieure" => "Superseded by a later attempt",
    "invitation remplacée" => "replaced invitation",
    "Aucune invitation trouvée." => "No invitation found.",
    "Mes statistiques de relecture" => "My reviewing statistics",
    "Cette page affiche l'intégralité de votre historique. Les responsables de la revue, eux, n'ont accès qu'aux 24 derniers mois glissants de vos statistiques." => "This page shows your entire history. The journal's managers, however, only have access to your statistics from the last 24 rolling months.",
    "Invitations en attente :" => "Pending invitations:",
    "Relectures en cours :" => "Reviews in progress:",
    "Relectures effectuées :" => "Completed reviews:",
    "Relectures effectuées" => "Completed reviews",
    "Relectures en retard :" => "Overdue reviews:",
    "%d jour max" => array("%d day max", "%d days max"),
    "Relances reçues :" => "Reminders received:",
    "Taux d’acceptation :" => "Acceptance rate:",
    "Taux de réponse :" => "Response rate:",
    "Délai moyen de relecture :" => "Average review time:",
