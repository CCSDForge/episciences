...
return [
    ...
    "invitation en attente" => 'unanswered review/rating invitation',
    "invitation obsolète" => 'obsolete review/rating invitation',
    'relecture obsolète' => 'obsolete review/rating',
    'relectures obsolètes' => 'obsolete reviews/ratings',
    ...
    "La grille d'évaluation n'est pas encore disponible" => "The review/rating grid is not available yet",
    "vous" => 'you',
    "l'auteur" => "the author",
    "relecteur" => "reviewer",
    ...
    "relu" => "reviewed",
    "relu en attente de décision éditoriale" => "reviewed pending editorial decision",
    "accepté" => "accepted",
    "publié" => "published",
    "refusé" => "refused",
    "obsolète" => "obsolete",
    ...
    "article relu en attente de décision éditoriale" => "reviewed article pending editorial decision",
    "articles relus en attente de décision éditoriale" => "reviewed articles pending editorial decision",
    ...
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_ARTICLE_RATING_LINK] => "link to the form to fill in for the article's rating",
    ...
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_REQUIRED_REVIEWERS_COUNT] => 'minimum ratings count: minimum ratings count required for accepting an article',
    ...
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_UPDATED_DEADLINE] => "new reviewing deadline",
    ...
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_REMINDER_BEFORE_RATING_DEADLINE_REVIEWER_VERSION][Episciences_Mail_TemplatesManager::DESCRIPTION] => "reminder notification of approaching rating deadline",

    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_REMINDER_BEFORE_RATING_DEADLINE_EDITOR_VERSION][Episciences_Mail_TemplatesManager::DESCRIPTION] => "notification informing editors of approaching rating deadline",
