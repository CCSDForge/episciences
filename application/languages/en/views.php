...
return [
    ...
    "Afficher les rapports de relecture sur la page de consultation publique d'un article" => "Display review/rating reports on the public viewing page of an article",
    ...
    "Délai de relecture par défaut" => "Default review/rating delay",
    "Délai de relecture minimum" => "Minimum review/rating delay",
    "Délai de relecture maximum" => "Maximum review/rating delay",
    "Minimum de relectures requis" => "Minimum review/ratings count",
    "Nombre minimum de relectures avant de pouvoir accepter un article." => "Minimum review/ratings count required for accepting an article.",
    ...
    "Evaluations" => 'Reviews',
    "Aucune évaluation terminée pour le moment." => 'No review/rating yet',
    ...
    "Vous n'avez pas les droits suffisants pour changer le statut de cette relecture" => "You don't have the required permissions to change the status of this review/rating",
    ...
    "classique" => "standard",
    "La nouvelle grille a bien été enregistrée." => "The new review/rating grid has been successfully saved.",
    ...
    "Votre évaluation a bien été enregistrée." => "Your review/rating has been saved.",
    "Votre évaluation n'a pas pu être enregistrée." => "Your review/rating could not be saved.",
    ...
    "La grille d'évaluation n'est pas encore disponible" => "The review/rating grid is not yet available",
    "vous" => 'you',
    "l'auteur" => "the author",
    "relecteur" => "reviewer",
    ...
    "Délai avant remise de la relecture, une fois l'invitation acceptée :" => "Delay before review/rating delivery, once the invitation has been accepted:",
    ...
    'Modification de la donnée liée bien prise en compte' => 'Linked data changed successfully',
    'Donnée liée déjà existante, veuillez changer ses informations via le formulaire' => 'The linked data already exists, please modify the information using the form',
    ...
    'Ajouter un jeu de données ou lien de publication' => 'Add a dataset, publication or software link',
    'software' => 'Software',
    'doi' => 'DOI',
    'handle' => 'Handle',
    'hal' => 'HAL',
    ...
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_PAPER_POSITION_IN_VOLUME] => "position de l'article dans un volume",
    ...
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_RATING_DEADLINE] => 'date limite de rendu de relecture (traduite dans la langue du destinataire)',
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_RECIPIENT_EMAIL] => "adresse mail du destinataire",
    ...
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_REFUSAL_REASON] => "motifs de refus d'un invitation à relire un article",
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_REFUSED_ARTICLE_MESSAGE] => "contient ce message : Cet article a été précédemment refusé dans sa première version, pour le consulter, merci de suivre ce lien : ",
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_REFUSED_PAPER_URL] => "lien vers la version refusée de l'article",
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_REMINDER_DELAY] => "différence, en nombre de jours, entre le moment où le rappel a été envoyé et la date limite",
    Episciences_Mail_Tags::TAG_DESCRIPTION[Episciences_Mail_Tags::TAG_REQUESTER_SCREEN_NAME] => "Screen Name of the originator of the action",
    ...
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_UPDATED_RATING_DEADLINE][Episciences_Mail_TemplatesManager::DESCRIPTION] => "notification informing the reviewer of the new review/rating deadline",
    ...
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_REVIEWER_INVITATION_NEW_USER][Episciences_Mail_TemplatesManager::DESCRIPTION] => "notification of invitation of a new reviewer with a temporary account. In this specific case and precise moment of the acceptance of the invitation, the user will be invited to create a new account to access the review/rating grid",
