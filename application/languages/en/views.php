...
return array(
    ...
    "a répondu à votre message concernant" => "responded to your message about",
    "vous a envoyé un message concernant" => "sent you a message about",
    "a répondu aux rédacteurs concernant" => "responded to the editors about",
    "a envoyé un message aux rédacteurs concernant" => "sent a message to the editors about",
    "Rédacteurs" => "Editors",
    ...
    "un article dont vous êtes responsable" => "an article you're managing",
    "un article que vous avez co-signé" => "an article you co-authored",
    ...
    "Ajouter" => 'Add',
    "Modifier" => 'Edit',
    "Assigner au volume principal" => 'Assign main volume',
    "Supprimer" => 'Remove',
    "Valider" => 'Submit',
    "Annuler" => 'Cancel',
    ...
    "Les rédacteurs peuvent refuser les articles" => "Editors can reject articles",
    ...
    "Propriétés du volume et ordre des articles" => 'Volume properties and article order',
    ...
    "Cet article a été refusé, il n'est plus nécessaire de le relire." => "Thank you but this article has been rejected, it is useless to review it now.",
    ...
    'Fichier principal' => "Primary file",
    "Aucun fichier PDF n'est joint à ce dépôt." => "No PDF file is attached to this submission.",
    // proceedings
    ...
    "suggère de refuser l'article" => "suggests to reject this article",
    ...
    "Vous n'êtes pas autorisé à répondre à cet auteur." => "You are not authorized to reply to this author.",
    "Vous n'êtes pas autorisé à répondre." => "You are not authorized to reply.",
    "Votre message n'a pas pu être envoyé." => "Your message could not be sent.",
    "Une erreur s'est produite lors de l'envoi du message." => "An error occurred while sending the message.",
    "Erreur lors de la sauvegarde de votre réponse." => "Error saving your reply.",
    "Le commentaire ne peut pas être vide." => "The comment cannot be empty.",
    "Erreur de validation du formulaire. Veuillez réessayer." => "Form validation error. Please try again.",
    ...
    "Discussion interne des rédacteurs/rédactrices" => "Internal editors' discussion",
    "Non visible par les auteurs/autrices" => "Not visible to authors",
    ...
    'Créer une grille' => 'Create an evaluation grid',
    ...
    "Suggérer de refuser l'article : détails" => "Suggest to reject this article: details",
    ...
    "Rechercher dans les logs" => 'Search in history',
    "Ouvrir le filtre par date" => 'Open date filter',
    "Calendrier" => 'Calendar',
    "Date de début" => 'Start date',
    "Date de début du filtre" => 'Filter start date',
    "Date de fin" => 'End date',
    "Date de fin du filtre" => 'Filter end date',
    ...
    // Paper logger action labels
    "Abandon du processus de publication" => "Publication process abandoned",
    "Accepté, demande de la version finale à l'auteur" => "Accepted, requesting final version from author",
    "Accepté, en attente de validation par l'auteur" => "Accepted, awaiting author validation",
    "Modification du statut du rapport" => "Report status modified",
    "Lettre de présentation de l'auteur" => "Author's cover letter",
    "Nouvelle soumission : transférée automatiquement depuis" => "New submission: automatically transferred from",
    "Reprise du processus de publication" => "Publication process resumed",
    "Version finale soumise par l'auteur (édition)" => "Final version submitted by author (copy editing)",
    "Version finale de l'auteur déposée (édition)" => "Author's final version deposited (copy editing)",
    "Demande de la version finale à l'auteur (édition)" => "Request for author's final version (copy editing)",
    "Sources de l'auteur déposées (édition)" => "Author's sources deposited (copy editing)",
    ...
    "Suppression d'une donnée liée" => "Linked data removed",
    "Envoi d'un e-mail" => "Email sent",
    "Ne plus gérer l'article" => "Editor monitoring declined",
    'Nouveau commentaire' => 'New comment',
    'Nouvelle date limite de rendu de relecture' => 'New reviewing deadline',
    "Sélection des volumes secondaires" => "Secondary volumes selection",
    "Modification de la date de publication" => "Publication date modified",
    "Réponse à une demande d'éclaircissement (contributeur au relecteur)" => "Reply to a clarification request (contributor to reviewer)",
    "Message de l'auteur aux rédacteurs assignés" => "Author's message to assigned editors",
    "message du rédacteur à l'auteur" => "Editor's message to author",
    "Demande d'éclaircissements (relecteur au contributeur)" => "Clarification request (reviewer to contributor)",
    "Article mis à jour" => "Article updated",
    "Envoi d'une relance automatique" => "Automatic reminder sent",
    "Restauration du statut" => "Status restored",
    "Date limite de révision mise à jour" => "Revision deadline updated",
    'Réponse à une demande de modifications' => 'Reply to a revision request',
    'Réponse à une demande de modifications (nouvelle version)' => 'Reply to a revision request (new version)',
    'Réponse à une demande de modifications (version temporaire)' => 'Reply to a revision request (temporary version)',
    "Assignation d'un relecteur" => "Reviewer assigned",
    "Invitation d'un relecteur" => "Reviewer invitation",
    "Invitation de relecture acceptée" => "Review invitation accepted",
    "Invitation de relecture refusée" => "Review invitation declined",
    "Suppression d'un relecteur" => "Reviewer unassigned",
    "Relecture terminée" => "Review completed",
    "Relecture en cours" => "Review in progress",
    "Déplacé dans une rubrique" => "Moved to a section",
    'Nouveau statut' => 'New status',
    'Descripteur de logiciel chargé' => 'Software descriptor uploaded',
    'Numéro de version mis à jour' => 'Version number updated',
    "Déplacé dans un volume" => "Moved to a volume",
    ...
    "Erreurs" => "Errors",
    "La nouvelle date limite de rendu de relecture doit être postérieure au %s." => "The new review submission deadline must be set after %s.",
    "La nouvelle date limite de rendu de relecture doit être antérieure au %s." => "The new review submission deadline must be set before %s.",
    "La date limite saisie est invalide." => "The entered deadline is invalid.",
    ...
    "Lorsqu'un article est soumis, mis à jour ou refusé, notifier les" => "When an article is submitted, updated or rejected, notify the",
    "Administrateurs" => "Administrators",
    'Activer la fonctionnalité' => 'Enable feature',
    "En cas de refus d'un article, le message envoyé aux auteurs/autrices expliquant la décision finale prise par le rédacteur/la rédactrice responsable est transmise automatiquement aux relecteurs/relectrices." => "In case an article has been rejected, the message sent to the authors explaining the final decision made by the editor in charge is forwarded automatically to the reviewers.",
    ...
    "administratepaper-saverefusedmonitoring" => "Decline to manage an article",
    "administratepaper-savesection" => "Move an article to another section",
    "administratepaper-suggeststatus" => "Suggest to accept/reject/request an update of an article",
    ...
    "Cet article a déjà été soumis et refusé. Avez-vous apporté des modifications majeures au document ?" => "This article has already been submitted and rejected. Have you made any major changes to the document?",
    "Cet article a été précédemment refusé dans sa première version, pour le consulter, merci de suivre ce lien : " => "This article was previously rejected in its first version, to consult it, please follow this link: ",
    "Cet article a déjà été soumis et refusé, merci de contacter le comité editorial." => "This article has already been submitted and rejected, please contact the editorial committee.",
    ...
    "Je refuse de relire cet article" => "I decline to review this article",
    ...
    "Visibilité du répertoire" => "Folder visibility",
    "Publique" => "Public",
    ...
    "administratemailinglist-index" => "List mailing lists",
    "administratemailinglist-edit" => "Create or edit a mailing list",
    "administratemailinglist-manage" => "Manage mailing list members",
    "administratemailinglist-delete" => "Delete a mailing list",
    "administratemailinglist-preview" => "Audience preview",
    "Modifier une liste" => "Edit a mailing list",
    "Gérer les membres" => "Manage members",
    "Supprimer une liste" => "Delete a mailing list",
    "Aperçu de l'audience" => "Audience preview",
    "mailing_list_type_open" => "Open — anyone can send",
    "mailing_list_type_subscribers" => "Members only — only members can send",
    "Controls who can send messages to this list." => "Controls who can send messages to this list.",
    "Enabled" => "Enabled",
    "Disabled" => "Disabled",
    "The type of the mandatory mailing list is fixed to: Open (anyone can send)." => "The type of the mandatory mailing list is fixed to: Open (anyone can send).",
    "The list has been automatically disabled because it has no members." => "The list has been automatically disabled because it has no members.",
    "Leave empty to use the main journal list. A dash is added automatically: rvcode-yourname@domain" => "Leave empty to use the main journal list. A dash is added automatically: rvcode-yourname@domain",
    "Mailing Lists" => "Mailing Lists",
    "Create a new list" => "Create a new list",
    "No mailing list found." => "No mailing list found.",
    ...
    "Add users" => "Add users",
    "No individual members selected." => "No individual members selected.",
    "Save Members" => "Save Members",
    "Mailing list members saved successfully." => "Mailing list members saved successfully.",
    "The list has been automatically closed because it has no members." => "The list has been automatically closed because it has no members.", // legacy key kept for DB entries
    ...
    "All roles" => "All roles",
    "Final Audience Preview" => "Final Audience Preview",
    "Update Preview" => "Update Preview",
    "Search in audience" => "Search in audience",
    "Firstname" => "Firstname",
    "Lastname" => "Lastname",
    "Email" => "Email",
    "Copy to clipboard" => "Copy to clipboard",
    "Copied!" => "Copied!",
    "Copy list name to clipboard" => "Copy list name to clipboard",
    "No members match the current selection." => "No members match the current selection.",
    "Get started by creating your first list" => "Get started by creating your first list",
    "Edit Settings" => "Edit Settings",
    "Manage Members" => "Manage Members",
    "The mandatory mailing list cannot be deleted." => "The mandatory mailing list cannot be deleted.",
    "The type of the mandatory mailing list is fixed to Open." => "The type of the mandatory mailing list is fixed to Open.", // legacy key kept
    "The journal prefix and domain are added automatically." => "The journal prefix and domain are added automatically.",
    "The journal prefix and domain are added automatically. Leave the name empty to manage the main journal list." => "The journal prefix and domain are added automatically. Leave the name empty to manage the main journal list.",
    "(optional sub-name)" => "(optional sub-name)",
    "Only alphanumeric characters, dots, dashes and underscores are allowed." => "Only alphanumeric characters, dots, dashes and underscores are allowed.",
    "The journal code is automatically added as a prefix." => "The journal code is automatically added as a prefix.",
    "Save Changes" => "Save Changes",
    "users" => "users",
    "Add Individual Members" => "Add Individual Members",
    "All active roles" => "All active roles",
    "Search by name or pseudonym" => "Search by name or pseudonym",
    "Search by name, screen name or role..." => "Search by name, screen name or role...",
    "Filter final audience by name or email..." => "Filter final audience by name or email...",
    "Member" => "Member",
    "This list is dynamically resolved from active roles and individual members." => "This list is dynamically resolved from active roles and individual members.",
    "Changes take effect immediately for the view." => "Changes take effect immediately for the view.",
    "Audience preview updated" => "Audience preview updated",
    "Failed to update preview" => "Failed to update preview",
    "Refresh based on current selections" => "Refresh based on current selections",
    "Search by name, screen name or role" => "Search by name, screen name or role",
    ...
    "le nombre d'articles refusés" => "the number of rejected articles",
    ...
    "Cela inclut les articles qui ont été soumis antérieurement et refusés cette année." => "This includes articles that were previously submitted and rejected this year.",
    ...
    "articles refusés (soumis la même année)" => "rejected articles (submitted in the same year)",
    ...
    "Conflit d'intérêts (CI) : annulé" => "Conflict of interest (COI): reverted",
    ...
    "Continuer (Pas de conflit d'interêt)" => 'Continue (No conflict of interest)',
    "Stop (J'ai un conflit d'interêt)" => 'Stop (I have a conflict of interest)',
    ...
    "Disponible uniquement lorsque arXiv est la seule archive autorisée pour la soumission. Après acceptation, l'administrateur demande à l'auteur son mot de passe arXiv et sa version finale ; le préparateur de copie met l'article en page ; l'épreuve est envoyée à l'auteur pour validation ; après l'approbation de l'auteur, l'administrateur valide la mise en page puis publie l'article." => "Available only when arXiv is the sole repository allowed for submission. After acceptance, the administrator requests the author's arXiv password and final version; the copy editor lays out the paper; the proof is sent to the author for validation; once the author has approved it, the administrator validates the layout and publishes the paper.",
    ...
    "épreuve approuvée par l'auteur" => "author proof approved",
    "Utilisez le lien figurant dans le courriel de demande d'approbation pour consulter l'épreuve de votre article, puis approuvez ou refusez la mise en page." => "Use the link in the approval-request email to view the proof of your article, then approve or reject the layout.",
    "Approuver" => "Approve",
    "Refuser" => "Reject",
    "Approuver la mise en page" => "Approve the layout",
    "Refuser la mise en page" => "Reject the layout",
    ...
    'Version arXiv' => 'arXiv version',
    "Indiquez la version de l'article disponible sur arXiv que vous souhaitez déposer. Elle doit être au moins égale à %s." => "Enter the version of the article available on arXiv that you want to submit. It must be at least %s.",
    "Fichiers d'accompagnement" => 'Accompanying files',
    "Choisir des fichiers d'accompagnement" => 'Choose accompanying files',
    ...
    "Déposer la version finale au nom de l'auteur" => "Submit the final version on behalf of the author",
    "Répondre au nom de l'auteur" => "Respond on behalf of the author",
    "Approuver la mise en page au nom de l'auteur" => "Approve the layout on behalf of the author",
    "Refuser la mise en page au nom de l'auteur" => "Reject the layout on behalf of the author",
    "Vous remplissez ce formulaire au nom de l'auteur. L'action sera enregistrée avec votre identité." => "You are completing this form on behalf of the author. The action will be recorded under your identity.",
    'Déposer' => 'Deposit',
