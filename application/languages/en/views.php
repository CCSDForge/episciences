...
return array(
    ...
    "Invitation non destinée à votre compte. Connectez-vous pour plus de détails." => "Invitation not intended for your account. Log in for more details.",
    "Il apparaît qu'une réponse a déjà été transmise." => "It appears that a reply has already been sent.",
    "Lien non valide; le jeton transmis dans la requête est erroné." => "Invalid link; the token sent in the request is corrupted.",
    "Une invitation est déjà rattachée à ce compte ; merci de finaliser votre relecture." => " An invitation is already attached to this account; please complete your review.",
