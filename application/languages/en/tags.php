...
return array(
    ...
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_REQUEST_FINAL_VERSION_AUTHOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: request final version and arXiv password",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_REQUEST_FINAL_VERSION_AUTHOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::AUTHOR_RECEP_EXP,
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_FINAL_VERSION_DEPOSIT_AUTHOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: confirmation that the final version and arXiv password were submitted",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_FINAL_VERSION_DEPOSIT_AUTHOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::AUTHOR_RECEP_EXP,
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_FINAL_VERSION_DEPOSIT_EDITOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: notification that the author has submitted the final version and arXiv password",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_FINAL_VERSION_DEPOSIT_EDITOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::MANAGERS_RECEP_EXP,
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_START_LAYOUT_EDITING_AUTHOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: acknowledge receipt of the final version and start layout editing",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_START_LAYOUT_EDITING_AUTHOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::AUTHOR_RECEP_EXP,
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_INCORRECT_PASSWORD_AUTHOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: request a corrected arXiv password",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_INCORRECT_PASSWORD_AUTHOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::AUTHOR_RECEP_EXP,
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_INCORRECT_LATEX_AUTHOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: request corrected LaTeX/source files",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_INCORRECT_LATEX_AUTHOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::AUTHOR_RECEP_EXP,
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_SEND_PROOF_TO_AUTHOR_AUTHOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: send proof to author for validation",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_SEND_PROOF_TO_AUTHOR_AUTHOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::AUTHOR_RECEP_EXP,
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_RETURN_TO_LAYOUT_EDITING_COPYEDITOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: proof returned to layout editing",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_RETURN_TO_LAYOUT_EDITING_COPYEDITOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::MANAGERS_RECEP_EXP,
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_AUTHOR_APPROVED_PROOF_EDITOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: author approved the proof",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_AUTHOR_APPROVED_PROOF_EDITOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::MANAGERS_RECEP_EXP,
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_AUTHOR_REJECTED_PROOF_EDITOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: author requested changes to the proof",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_AUTHOR_REJECTED_PROOF_EDITOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::MANAGERS_RECEP_EXP,
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_APPROVE_FOR_PUBLICATION_AUTHOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: proof approved for publication",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_APPROVE_FOR_PUBLICATION_AUTHOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::AUTHOR_RECEP_EXP,
