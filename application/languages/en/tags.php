...
return array(
    ...
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_START_LAYOUT_EDITING_COPYEDITOR_COPY][Episciences_Mail_TemplatesManager::DESCRIPTION] => "alternative pipeline: request to start layout editing",
    Episciences_Mail_TemplatesManager::TEMPLATE_DESCRIPTION_AND_RECIPIENT[Episciences_Mail_TemplatesManager::TYPE_PAPER_ALT_START_LAYOUT_EDITING_COPYEDITOR_COPY][Episciences_Mail_TemplatesManager::RECIPIENT] => Episciences_Mail_TemplatesManager::MANAGERS_RECEP_EXP,
