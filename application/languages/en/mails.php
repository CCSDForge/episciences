...
return [
    ...
    "paper_alt_start_layout_editing_author_copy_tpl_name" => "Alternative pipeline: layout editing started - author copy",
    "paper_alt_start_layout_editing_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Layout editing has started",
