...
return [
    ...
    "paper_alt_request_final_version_author_copy_tpl_name" => "Alternative pipeline: request final version and password - author copy",
    "paper_alt_request_final_version_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Final version and arXiv password requested",
    "paper_alt_final_version_deposit_author_copy_tpl_name" => "Alternative pipeline: final version and password deposited - author copy",
    "paper_alt_final_version_deposit_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Your final version and password have been received",
    "paper_alt_final_version_deposit_editor_copy_tpl_name" => "Alternative pipeline: final version and password deposited - editor/copy editor copy",
    "paper_alt_final_version_deposit_editor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Final version and password submitted by the author",
    "paper_alt_start_layout_editing_copyeditor_copy_tpl_name" => "Alternative pipeline: layout editing started - copy editor copy",
    "paper_alt_start_layout_editing_copyeditor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Layout editing can start",
    "paper_alt_incorrect_password_author_copy_tpl_name" => "Alternative pipeline: incorrect arXiv password - author copy",
    "paper_alt_incorrect_password_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - The arXiv password must be updated",
    "paper_alt_incorrect_latex_author_copy_tpl_name" => "Alternative pipeline: incorrect LaTeX files - author copy",
    "paper_alt_incorrect_latex_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - The final version files must be updated",
    "paper_alt_send_proof_to_author_author_copy_tpl_name" => "Alternative pipeline: proof sent to author",
    "paper_alt_send_proof_to_author_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Please check the proof of your article",
    "paper_alt_return_to_layout_editing_copyeditor_copy_tpl_name" => "Alternative pipeline: return to layout editing - copy editor copy",
    "paper_alt_return_to_layout_editing_copyeditor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Proof returned to layout editing",
    "paper_alt_author_approved_proof_editor_copy_tpl_name" => "Alternative pipeline: proof approved by author - editor/copy editor copy",
    "paper_alt_author_approved_proof_editor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Proof approved by the author",
    "paper_alt_author_rejected_proof_editor_copy_tpl_name" => "Alternative pipeline: proof rejected by author - editor/copy editor copy",
    "paper_alt_author_rejected_proof_editor_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Proof changes requested by the author",
    "paper_alt_approve_for_publication_author_copy_tpl_name" => "Alternative pipeline: approved for publication - author copy",
    "paper_alt_approve_for_publication_author_copy_mail_subject" => "%%REVIEW_CODE%% #%%ARTICLE_ID%% - Your article is ready for publication",
