$(function () {
    ...
    $('.upload_widget').fileupload({
        ...
        add: function (e, data) {
            ...
            tpl_content += '<p>';
            tpl_content += '<a target="_blank" id="href-' + idCpt + '"><span class="file_name truncate"></span></a> ';
            ...
            tpl_content += '<div id="file_container_errors_' + idCpt + '" style="margin-top: 10px;"></div>';
            tpl_content += '</div>';
