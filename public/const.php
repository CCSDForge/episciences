...
function defineVendorJsLibraries()
{
    ...
    define('VENDOR_TINYMCE', 'https://cdnjs.cloudflare.com/ajax/libs/tinymce/7.2.0/tinymce.min.js');
    define('VENDOR_TINYMCE_JQUERY', 'https://cdnjs.cloudflare.com/ajax/libs/tinymce/7.2.0/tinymce.min.js');
